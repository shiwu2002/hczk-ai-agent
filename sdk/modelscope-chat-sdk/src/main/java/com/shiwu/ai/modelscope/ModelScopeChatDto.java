...
public class ModelScopeChatDto {
    ...
    public static class Request {
        ...
        /** 是否启用联网搜索（ModelScope 专用） */
        private Boolean enable_search;
        /** 是否启用思维链（ModelScope 专用，非流式调用时必须为 false） */
        ...
        public Boolean getEnable_search() { return enable_search; }
        public void setEnable_search(Boolean enable_search) { this.enable_search = enable_search; }

        public Boolean getEnable_thinking() { return enable_thinking; }
